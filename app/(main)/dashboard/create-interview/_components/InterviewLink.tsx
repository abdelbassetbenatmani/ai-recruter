...
export default function InterviewSuccess({
  ...
  const shareViaWhatsApp = () => {
    window.open(
      `https://wa.me/?text=Please complete this technical interview: ${interviewUrl}`,
    );
  };
  ...
  const shareViaSlack = () => {
    ...
    navigator.clipboard.writeText(
      `Please complete this technical interview for ${title}: ${interviewUrl}`,
    );
      ...
      <Card className="w-full max-w-md shadow-lg border-0 p-0">
        <CardHeader className="bg-gradient-to-r from-green-50 to-teal-50 rounded-t-lg p-6 text-center">
          ...
          <p className="text-gray-500 mt-2">
            Your technical interview is ready to be shared
          </p>
        </CardHeader>
        ...
        <CardContent className="px-6 space-y-6">
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-x-4">
              ...
              <div className="flex items-center space-x-2">
                <Badge
                  variant="outline"
                  className="bg-purple-50 text-purple-700 border-purple-200 px-2.5 py-0.5"
                >
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm  mt-2">
              Share this interview with candidates via link or apps below.
            </p>
          </div>
