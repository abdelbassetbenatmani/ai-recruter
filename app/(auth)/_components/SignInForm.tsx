    ...
    <div className="container flex min-h-[100dvh] items-center justify-center px-4 py-6 mx-auto bg-GREY_15 sm:py-8">
      <Card className="mx-auto w-full max-w-md border-GREY_30 hover:border-GREEN_60 transition-all duration-300 shadow-lg">
        <CardHeader className="space-y-1 px-6 pt-6 pb-4 sm:px-8 sm:pt-8">
          <CardTitle className="text-xl sm:text-2xl font-bold text-ABSOLUTE_WHITE text-center">
            Sign in to your account
          </CardTitle>
          <CardDescription className="text-GREY_60 text-center">
        ...
        <CardContent className="px-6 sm:px-8">
          <div className="grid gap-6">
            <div className="grid grid-cols-2 gap-4">
              <Button
                variant="outline"
                className="w-full border-GREY_30 hover:border-GREEN_60 hover:bg-GREEN_60/10 text-GREY_90 hover:text-GREEN_60 transition-all h-11"
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <Button
                  type="submit"
                  className="w-full bg-GREEN_60 hover:bg-GREEN_70 text-white h-11"
                  disabled={isLoading}
                >
